  ...
  return (
    <div className="main-page">
      <header className="header">
        <div className="menu-opened visually-hidden">
          <div className="menu-opened__wrapper">
            <div className="menu-opened__button burger">
              <svg
            ...
            <ul className="menu-opened__page-list">
              <li className="menu-opened__page-item">
                <a className="menu-opened__page-title" href="#">
                  Парковка
                </a>
              </li>
              <li className="menu-opened__page-item">
            ...
            <ul className="menu-opened__socials-list">
              <li className="menu-opened__socials-item">
                <a className="menu-opened__socials-icon" href="#">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
      ...
      <main className="main-container">
        ...
        <section className="slider ">
          ...
          {/* <div className="slider__wrapper">
            <article className="slider-item">
              <div className="slider-item__wrapper container">
                <h2 className="slider-item__title">Бесплатная парковка</h2>
                <p className="slider-item__text">
                  Оставляйте машину на платных городских парковках и разрешенных
                  местах, не нарушая ПДД, а также в аэропортах
                </p>
                <button className="button button--slider-item">
                  Подробнее
                </button>
              </div>
            </article>
          ...
          {/* <nav className="slider__nav">
              <span className="slider__point slider__point--active"></span>
