...
const HeaderMenu = () => {
  ...
  const [langEng, setLang] = useState(true);

  const handleClickMenuButton = () => {
    setOpened((state) => !state);
  };

  const handleClickLangToggle = () => {
    setLang((state) => !state);
  };

  return (
    <>
      <div className={menuOpened ? `menu-opened` : `visually-hidden`}>
        <div className="menu-opened__wrapper">
          <div
            className="menu-opened__button burger"
      ...
      <nav className="main-nav">
        <div className="main-nav__button">
          <button className="burger" onClick={handleClickMenuButton}>
            <svg
